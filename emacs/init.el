...
;; Cambio los valores te de teclas para que séan válidas en macOS en Español
(define-key evil-insert-state-map (kbd "M-ñ") (lambda () (interactive) (insert "~")))
...
(define-key evil-insert-state-map (kbd "M-º") (lambda () (interactive) (insert "\\")))
(define-key evil-insert-state-map (kbd "M-+") (lambda () (interactive) (insert "]")))
(define-key evil-insert-state-map (kbd "M-ç") (lambda () (interactive) (insert "}")))
